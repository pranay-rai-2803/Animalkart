    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            try {
                ...
                String userEamil = request.getParameter("user_email");
                ...
                if(userName.isEmpty()){
                    out.println("Username field cannot be blank");
                    return;
                }
                
                //Creating user object to store data
                
                User user = new User(userName, userEamil, userPassword, userPhone, "Default.jpg", userAddress, "normal");
                
                // Creating seassion to store 
